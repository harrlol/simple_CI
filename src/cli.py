...
# Setup
GCP_PROJECT = "apcomp215-434717" #"gemini707"
...
SYSTEM_INSTRUCTION = """
You are an AI assistant specialized in clinical knowledge. Your responses are based solely on the information provided in the text chunks given to you. Do not use any external knowledge or make assumptions beyond what is explicitly stated in these chunks.
...
5. Always maintain a professional and knowledgeable tone, befitting a clinical expert.
6. If there are contradictions in the provided chunks, mention this in your response and explain the different viewpoints presented.

Remember:
- You are an expert in clinical works, but your knowledge is limited to the information in the provided chunks.
- Do not invent information or draw from knowledge outside of the given text chunks.
- If asked about topics unrelated to clinical work, politely redirect the conversation back to clinical-related subjects.
- Be concise in your responses while ensuring you cover all relevant information from the chunks.

Your goal is to provide accurate, helpful information about clinical work based solely on the content of the text chunks you receive with each query.
"""
generative_model = GenerativeModel(
	GENERATIVE_MODEL, # change to finetuned model endpoint 
...
book_mappings = {
	"0": {"author":"MIMC-IV", "year": 2023},
	"1": {"author":"MIMC-IV", "year": 2023},
	"2": {"author":"MIMC-IV", "year": 2023},
	"3": {"author":"MIMC-IV", "year": 2023},
	"4": {"author":"MIMC-IV", "year": 2023},
	"5": {"author":"MIMC-IV", "year": 2023},
	"6": {"author":"MIMC-IV", "year": 2023},
	"7": {"author":"MIMC-IV", "year": 2023},
	"8": {"author":"MIMC-IV", "year": 2023},
	"9": {"author":"MIMC-IV", "year": 2023},
	"10": {"author":"MIMC-IV", "year": 2023},
	"11": {"author":"MIMC-IV", "year": 2023},
	"12": {"author":"MIMC-IV", "year": 2023},
	"13": {"author":"MIMC-IV", "year": 2023},
	"14": {"author":"MIMC-IV", "year": 2023},
	"15": {"author":"MIMC-IV", "year": 2023},
	"16": {"author":"MIMC-IV", "year": 2023},
	"17": {"author":"MIMC-IV", "year": 2023},
	"18": {"author":"MIMC-IV", "year": 2023},
	"19": {"author":"MIMC-IV", "year": 2023},
	"20": {"author":"MIMC-IV", "year": 2023},
	"21": {"author":"MIMC-IV", "year": 2023},
	"22": {"author":"MIMC-IV", "year": 2023},
	"23": {"author":"MIMC-IV", "year": 2023},
	"24": {"author":"MIMC-IV", "year": 2023},
	"25": {"author":"MIMC-IV", "year": 2023},
	"26": {"author":"MIMC-IV", "year": 2023},
	"27": {"author":"MIMC-IV", "year": 2023},
	"28": {"author":"MIMC-IV", "year": 2023},
	"29": {"author":"MIMC-IV", "year": 2023},
	"30": {"author":"MIMC-IV", "year": 2023},
	"31": {"author":"MIMC-IV", "year": 2023},
	"32": {"author":"MIMC-IV", "year": 2023},
	"33": {"author":"MIMC-IV", "year": 2023},
	"34": {"author":"MIMC-IV", "year": 2023},
	"35": {"author":"MIMC-IV", "year": 2023},
	"36": {"author":"MIMC-IV", "year": 2023},
	"37": {"author":"MIMC-IV", "year": 2023},
	"38": {"author":"MIMC-IV", "year": 2023},
	"39": {"author":"MIMC-IV", "year": 2023}
}
...
def load_text_embeddings(df, collection, batch_size=500):
	# Convert the 'book' column to string
...
def query(method="char-split"):
	...
	query = "What are the possible side effects of gemcitabine and capecitabine in pancreatic cancer treatment?"
...
def chat(method="char-split"):
	...
	query = "How is ascites managed in pancreatic cancer patients?"
	query_embedding = generate_query_embedding(query)
	print("Query:", query)
	print("Embedding values:", query_embedding)
	# Get the collection
...
def agent(method="char-split"):
	...
	user_prompt_content = Content(
    	role="user",
		parts=[
			Part.from_text("What are the signs of a partial bowel obstruction in pancreatic cancer?"),
		],
	)
